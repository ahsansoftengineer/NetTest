...
//             myPage.AddImage(50, yAxis, myDoc);
...
//         public static void AddImage(this pdfPage myPage, int x, int y, pdfDocument myDoc)
//         {
//             string imagePath = "user.jpg";
//             // Convert the image to a byte array
//             Stream imgData = ConvertImageToByteArray(imagePath);
//             // .addImageReference(imgData);
//             // myPage.addImage(pdfImg, 50, 750, 100, 50);
